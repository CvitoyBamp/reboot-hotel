...
-- Пользователи
insert into public.user(id, roles_id, name, birthday, password, email, phone) values ('1', '2','Василий','03.14.2000','123$2a$10$ZI3IFWvl02PrSyCZ3orysesMZKGA2pD.FGjzRHQYrBlrTJYk914V2456','vasya@ya.ru','89001234569');
...
insert into public.user(id, roles_id, name, birthday, password, email, phone) values ('4', '2','Игорь','09.18.1987','$2a$10$ZI3IFWvl02PrSyCZ3orysesMZKGA2pD.FGjzRHQYrBlrTJYk914V2','шпщк@нф.com','89011974269');
insert into public.user(id, roles_id, name, birthday, password, email, phone) values ('5', '1','admin','09.19.1987','$2a$10$ZI3IFWvl02PrSyCZ3orysesMZKGA2pD.FGjzRHQYrBlrTJYk914V2','admin@admin.ru','89091586789');
